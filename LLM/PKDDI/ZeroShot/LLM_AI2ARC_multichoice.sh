...
#SBATCH --time=3:00:00      # Time limit (24 hours)
#####SBATCH --array=10-100       # Job array index (1 task)
...
/home/seyedhamed.meshkin/anaconda3/bin/python3 DeepSeek_AI2ARC_multichoice.py  --output AI2ARC_validation_results${SLURM_ARRAY_TASK_ID} --run $SLURM_ARRAY_TASK_ID  >& logfiles/"$SLURM_JOB_ID".o.${SLURM_ARRAY_TASK_ID}.txt
